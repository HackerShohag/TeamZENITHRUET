...
import recruitment1 from '@/public/gallery/recruitment1.jpg';
			...
			<div className="flex flex-col items-center justify-center text-lg py-15 text-justify">
				...
				<div className="flex items-center justify-center flex-col md:flex-row">
					<div className="flex flex-col max-w-3xl pr-5 p-3">
						<p> A group of bright and enthusiastic young engineering students from RUET formed the team in 2019 with the goal of designing, constructing, and participating in various engineering contests across the world. For the very first time, the team aimed to compete in the Formulae Student Design competition, which is regarded as one of the most renowned engineering contests in the world. The crew was encouraged by their accomplishments to continue competing in engineering challenges, such as the NASA Human Rover Challenge, Formula Czech Republic 2020 championship, Formulae Kart Design Challenge session-7, etc.
						</p>
						<p className="py-2"> This competitions not only have gained respect and admiration from our peers and business experts but also have helped to build a strong background in automotive, business, rover design sector. These sets of skills and experiences along with teamwork are going to help us further more to accomplish our next goal.
						</p>
					</div>
					<div className="flex flex-col p-2">
						<Image radius="none" src={fkdc5.src} alt="FKDC5" width={1000} />
						<h6 className="text-center text-lg font-bold pt-2">Formula Kart Design Challenge 5</h6>
					</div>
				</div>
				<div className="flex flex-row gap-10 p-2">
					<Image radius="none" src={recruitment1.src} alt="FKDC5" width={1000} />
					<Image radius="none" src={chegRepublic1.src} alt="FKDC5" width={1000} />
				</div>
			</div>
		</div>
	);
