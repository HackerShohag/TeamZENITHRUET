	...
	return (
		<section className="flex flex-col items-center justify-center gap-4 py-5 md:py-10">
			...
			<div className="flex flex-row w-full justify-between">
				<div className="flex flex-col w-full">
					<div className="flex flex-row justify-between items-center">
						<div className="">
							<h1 className={title({ size: 'lg', class: "font-black", color: "zenith" })}>
								Team ZENITH RUET
							</h1>
							<br />
			...
			<div className="flex w-full gap-3">
				<Link isExternal href="/" className={buttonStyles({ class: "rounded text-white font-bold bg-[#E34333]", color: "danger", radius: "full", variant: "shadow", size: 'lg' })}>Join the team</Link>
